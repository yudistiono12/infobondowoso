	...
	class ReduxFramework_kad_slides {
		...
		public function render() {
			 ...
			 if ( $x == 0 ) {
				 ...
				 echo '<input type="checkbox" class="checkbox-slide-target" id="' . esc_attr( $this->field['id'] ) . '-target_' . esc_attr( $x ) . '" value="" ' . checked( '', '1', false ) . ' name="' . $this->field['name'] . '[' . esc_attr( $this->field['id'] ) . '][' . esc_attr( $x ) . '][target]" />';
				 echo ' ' . __( 'Open Link in New Tab/Window', 'pinnacle' ) . '</label></li>';
