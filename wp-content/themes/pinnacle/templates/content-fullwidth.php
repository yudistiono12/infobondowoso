<?php global $post, $pinnacle;
		$slide_sidebar = 1170;
$portraittext = 'col-md-8';
$portraitimg = 'col-md-4';
		 // Get summary setting
							  ...
							  <div class="col-md-12">
								  <div class="imghoverclass img-margin-center">
									<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>">
										<img src="<?php esc_attr( $img['src'] ); ?>" alt="<?php esc_attr( $img['alt'] ); ?>" width="<?php echo esc_attr( $img['width'] ); ?>" height="<?php echo esc_attr( $img['height'] ); ?>" <?php echo wp_kses_post( $img['srcset'] ); ?> class="iconhover" style="display:block;" />
									</a> 
								  </div>
							  </div>
							<?php
													...
													?>
													  <li>
														<a href="<?php the_permalink(); ?>">
														  <img src="<?php esc_attr( $img['src'] ); ?>" alt="<?php esc_attr( $img['alt'] ); ?>" width="<?php echo esc_attr( $img['width'] ); ?>" height="<?php echo esc_attr( $img['height'] ); ?>" <?php echo wp_kses_post( $img['srcset'] ); ?> />
														</a>
													  </li>
													<?php
												}
