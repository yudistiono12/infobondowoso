 ...
 * Theme options output css.
 */
function pinnacle_custom_css() {

	global $pinnacle;

	if ( isset( $pinnacle['topbar_height'] ) && isset( $pinnacle['topbar'] ) && '1' === $pinnacle['topbar'] ) {
...
add_action( 'wp_head', 'pinnacle_custom_css' );
