...
use LaStudioKitThemeBuilder\Modules\ThemeBuilder\Classes;
...
class Module extends \Elementor\Core\Base\Module {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, [
            ...
            'urls' => [
                'modules' => lastudio_kit()->plugin_url('')
            ]
		] );
	...
	public function register_controls() {
		$controls_manager = lastudio_kit()->elementor()->controls_manager;
    ...
    public function enqueue_editor_scripts() {
        ...
        wp_enqueue_script(
            'lastudio-kit-editor-conditions',
            lastudio_kit()->plugin_url( 'assets/js/lastudio-kit-editor-conditions.js' ),
            [
                'backbone-marionette',
                'elementor-common',
        ...
        $locale_settings = apply_filters('lastudiokit_pro/admin/localize_settings', $locale_settings);
	...
	public function __construct() {
		...
		add_filter( 'lastudiokit_pro/admin/localize_settings', [ $this, 'localize_settings' ] );
