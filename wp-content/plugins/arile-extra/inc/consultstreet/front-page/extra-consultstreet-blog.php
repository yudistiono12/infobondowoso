...
if($consultstreet_blog_disabled == true): ?>
	<section class="theme-block theme-blog <?php if($activate_theme == 'BrightPress' || $activate_theme == 'FitnessBase' || $activate_theme == 'Beauty Spa Salon') { echo 'list-view-news'; } ?>" id="theme-blog">
